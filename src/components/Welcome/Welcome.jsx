    ...
    return (
        <section className="pt-24">
            ...
            <div className="flex justify-center items-center p-4">
                ...
                place-items-center p-6 bg-teal-700 rounded-3xl lg:max-w-5xl">

                    <div>
                        <h1 className="text-slate-200 text-center lg:text-left
                         text-3xl lg:text-6xl font-extrabold pt-4 pb-4 lg:p-4">
                            Hello!<br /> 
                            Nice to have you here! 
                        </h1>

                        <p className="text-slate-200 p-3 lg:p-6">
